...
public partial class MainWindow : Gtk.Window
{
	...
	protected void SetupEditRegion(int Region)
	{
		if (Region > 0)
		{
			...
			GtkSelection.Selection.Size(Region, out width, out height);
			SetupEditRegionLocations(GtkSelection.Selected);
	...
	protected void SetupEditRegionLocations(int Region)
	{
		if (Region > 0)
		{
			...
			GtkSelection.Selection.Location(Region, out x, out y);
	...
	protected void ClearRegions(object sender, EventArgs e)
	{
		if (ControlsActive)
		{
			ClearRegions();
	...
	protected void ScaleResizeEvent(object sender, EventArgs e)
	{
		if (ControlsActive)
		{
			if (editEnabled)
	...
	protected void NumericResizeEvent(object sender, EventArgs e)
	{
		if (ControlsActive)
		{
			if (editEnabled)
	...
	protected void ScaleMove()
	{
		if (ControlsActive)
		{
			if (GtkSelection.Selected > 0)
			{
				...
				GtkSelection.Selection.Location(GtkSelection.Selected, out x, out y);
	...
	protected void ScaleMoveEvent(object sender, EventArgs e)
	{
		if (ControlsActive)
		{
			if (editEnabled)
	...
	protected void NumericMoveEvent(object sender, EventArgs e)
	{
		if (ControlsActive)
		{
			if (editEnabled)
	...
	protected void OnSelectImageButtonClicked(object sender, EventArgs e)
	{
	...
	protected void OnDetectCirclesButtonClicked(object sender, EventArgs e)
	{
		HideEdit();
	...
	protected void OnDetectBlobsButtonClicked(object sender, EventArgs e)
	{
		HideEdit();
	...
	protected void OnBlobDetectorButtonClicked(object sender, EventArgs e)
	{
		HideEdit();
	...
	protected void OnSimpleBlobDetectorClicked(object sender, EventArgs e)
	{
		HideEdit();
	...
	protected void OnSubtractBgToggled(object sender, EventArgs e)
	{
		cv.SubtractBackground = subtractBg.Active;
	}

	protected void OnDownUpSampleToggled(object sender, EventArgs e)
	{
		cv.DownUpSample = downUpSample.Active;
	}

	protected void OnImgInvertToggled(object sender, EventArgs e)
	{
		cv.Invert = imgInvert.Active;
	}

	protected void OnGaussianBlurToggled(object sender, EventArgs e)
	{
		cv.Blur = gaussianBlur.Active;
	}

	protected void OnSxValueChanged(object sender, EventArgs e)
	{
		sx.Value = sx.ValueAsInt;
		cv.sx = sx.ValueAsInt;
	}

	protected void OnSyValueChanged(object sender, EventArgs e)
	{
		sy.Value = sy.ValueAsInt;
		cv.sy = sy.ValueAsInt;
	}

	protected void OnSigmaXValueChanged(object sender, EventArgs e)
	{
		cv.sigmaX = sx.Value;
	}

	protected void OnSigmaYValueChanged(object sender, EventArgs e)
	{
		cv.sigmaY = sy.Value;
	}

	protected void OnNormalizeToggled(object sender, EventArgs e)
	{
		cv.Normalize = normalize.Active;
	}

	protected void OnSaveBlobsButtonClicked(object sender, EventArgs e)
	{
	...
	protected void OnSaveProcessedImageClicked(object sender, EventArgs e)
	{
		if (ControlsActive)
		{
	...
	protected void OnMarkerSizeValueChanged(object sender, EventArgs e)
	{
